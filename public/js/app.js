...
/* src\js\App.svelte generated by Svelte v3.46.2 */
...
function create_if_block(ctx) {
  ...
  return {
    c: function c() {
      ...
      div3.innerHTML = "<nav class=\"\"><div class=\"bg-orange-200\"><div class=\"pt-2 text-xl text-center text-orange-600\">Contact us now!</div> \n                    <div class=\"flex flex-wrap justify-center\"><button class=\"flex items-center justify-center w-full\"><span class=\"pl-4 pr-1 text-orange-600\">613</span> \n                            <span class=\"px-1 pr-6 text-2xl text-orange-800\">800-8629</span></button> \n                        <input class=\"hidden w-full text-xl text-center text-orange-800 bg-orange-200\" type=\"text\" readonly=\"readonly\" value=\"613-800-8629\"/> \n                        <a class=\"flex justify-center w-1/2 py-2 text-xl text-orange-50 bg-amber-600 hover:text-orange-700 hover:bg-orange-50\" href=\"tel:+6138008629\">Call</a> \n                        <a class=\"flex justify-center w-1/2 py-2 text-xl text-orange-50 bg-amber-600 hover:text-orange-700 hover:bg-orange-50\" href=\"tel:+6138008629\">Text</a></div></div> \n                <ul class=\"\"><li><a class=\"block pl-2 pr-4 border-l-[.6em] border-transparent hover:border-orange-500 py-4 w-full track hover:bg-orange-200\" href=\"#about\">About Us</a></li> \n                    <li><a class=\"block pl-2 pr-4 border-l-[.6em] border-transparent hover:border-orange-500 py-4 w-full track hover:bg-orange-200\" href=\"#whatwedo\">What We Do</a></li> \n                    <li><a class=\"block pl-2 pr-4 border-l-[.6em] border-transparent hover:border-orange-500 py-4 w-full track hover:bg-orange-200\" href=\"#contact\">Get In Touch</a></li></ul></nav>";
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr)(div3, "x-show", "open");
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr)(div3, "class", "absolute right-5 z-10 bg-white -mt-[1px] shadow-lg rounded-b-md overflow-hidden");
    },
...
function create_fragment(ctx) {
  ...
  return {
    c: function c() {
      ...
      div0.innerHTML = "<a class=\"flex-1 px-3 py-4 text-4xl font-thin tracking-wide text-gray-100\" href=\"/\">MAXX<span class=\"font-bold text-orange-600\">RENO</span></a> \n        <button class=\"px-5 py-4 text-gray-500 rounded-md hover:text-white focus:text-white focus:ring-2 ring-white\" type=\"button\"><svg class=\"w-8 h-8\" viewBox=\"0 0 24 24\"><path fill=\"currentColor\" d=\"M3,6H21V8H3V6M3,11H21V13H3V11M3,16H21V18H3V16Z\"></path></svg></button>";
      t3 = (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.space)();
      div1 = (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.element)("div");
      if (if_block) if_block.c();
      t4 = (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.space)();
      main = (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.element)("main");
      main.innerHTML = "<div class=\"relative z-0 w-full max-w-4xl mx-auto bg-right-bottom bg-cover bg-clip-border\" style=\"background-image: url(&#39;https://i.pinimg.com/originals/8b/1f/36/8b1f3624ddf6ea5f16b8ff0e564199cd.jpg&#39;);\"><div class=\"grid items-center grid-cols-1 grid-rows-4 gap-4 pt-10\"><a href=\"#woodflooring\" class=\"flex items-end w-full max-w-sm mx-auto overflow-hidden bg-cover border border-orange-300 rounded-md group bg-clip-border\" style=\"background-image: url(&#39;https://livedemo00.template-help.com/wt_48139/images/cat1.jpg&#39;)\"><span class=\"w-full py-1 mt-32 text-2xl text-center bg-orange-600 group-hover:bg-opacity-100 bg-opacity-60\"><span class=\"font-bold text-white group-hover:text-white\">WOOD</span> \n                    <span class=\"font-normal text-orange-900 group-hover:text-white\">FLOORING</span></span></a> \n\n            <a href=\"#tileflooring\" class=\"flex items-end w-full max-w-sm mx-auto overflow-hidden bg-right-bottom bg-cover border border-orange-300 rounded-md group bg-clip-border\" style=\"background-image: url(&#39;https://assets.llflooring.com/image/upload/dpr_auto,f_auto,q_auto/10043942_rs&#39;)\"><span class=\"w-full py-1 mt-32 text-2xl text-center bg-orange-600 group-hover:bg-opacity-100 bg-opacity-60\"><span class=\"font-bold text-white group-hover:text-white\">TILE</span> \n                    <span class=\"font-normal text-orange-900 group-hover:text-white\">FLOORING</span></span></a> \n\n            <a href=\"#decks\" class=\"flex items-end w-full max-w-sm mx-auto overflow-hidden bg-right-bottom bg-cover border border-orange-300 rounded-md group bg-clip-border\" style=\"background-image: url(&#39;https://www.thespruce.com/thmb/6OvHPYNbEqH71Y0mtfrWX3f5T8Q=/2121x1414/filters:no_upscale():max_bytes(150000):strip_icc()/canadian-house-in-beaconsfield--montreal--quebec--canada-1151466737-f001652970344fcb9ea87a7d99daf917.jpg&#39;)\"><span class=\"w-full py-1 mt-32 text-2xl text-center bg-orange-600 group-hover:bg-opacity-100 bg-opacity-80\"><span class=\"font-bold text-white group-hover:text-white\">BATHROOM</span> \n                    <span class=\"font-normal text-orange-900 group-hover:text-white\">RENO</span></span></a> \n\n            <a href=\"#woodflooring\" class=\"flex items-end w-full max-w-sm mx-auto overflow-hidden bg-left-bottom bg-cover border border-orange-300 rounded-md group bg-clip-border\" style=\"background-image: url(&#39;https://www.renoassistance.ca/wp-content/uploads/2020/10/kitchen-design-950x633.jpg&#39;)\"><span class=\"w-full py-1 mt-32 text-2xl text-center bg-orange-600 group-hover:bg-opacity-100 bg-opacity-80\"><span class=\"font-bold text-white group-hover:text-white\">KITCHEN</span> \n                    <span class=\"font-normal text-orange-900 group-hover:text-white\">RENO</span></span></a></div> \n        <div class=\"pt-8\"></div></div> \n    \n    <article class=\"w-full max-w-4xl mx-auto\"><div id=\"welcome\" class=\"pt-6 bg-gray-100\"><h2 class=\"px-4 text-2xl font-semibold text-gray-500\">Welcome!</h2> \n            <p class=\"px-4 py-2\">With so many companies offering home renovations in Ottawa and Gatineau, you may ask\n                yourself many questions when choosing your Contractor. Why should clients work with MaxxReno instead of\n                another local company? What can we offer you that other companies cannot? At MaxxReno, we have brought\n                together the expertise and artistry of many local professionals to create a company unlike any other.\n                When you choose to work with us, you can feel confident that you will receive:</p> \n            <div class=\"grid grid-cols-1\"></div></div></article> \n    \n    \n    \n    <aside class=\"w-full max-w-4xl mx-auto\"><div id=\"contact\" class=\"pt-4 bg-gray-100\"><h2 class=\"px-4 text-2xl font-semibold text-gray-500\">Get In Touch</h2> \n            <p class=\"px-4 py-2\">Kay2 Contracting&#39;s vision is to provide premium renovation and home improvement\n                solutions by combining our clients&#39; needs and desires with extraordinary designs, exceptional service,\n                professional workmanship, and integrity. Every customer, private or trade, large or small, will receive\n                the exceptional service they deserve. We work to exceed expectations in everything that we do, and we\n                always hope that our past customers will come back to us for future projects, and refer our services to\n                others in the area. We understand that your home is a major investment, and we take great pride in\n                working closely with you to create the space you&#39;ve always wanted.</p></div></aside>";
      ...
      footer.innerHTML = "<div class=\"w-full max-w-4xl\"><ul class=\"flex flex-wrap gap-3\"><li><a href=\"/\">Home</a></li></ul></div>";
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr)(div0, "class", "flex items-center justify-between w-full max-w-4xl mx-auto bg-gray-800 bg-opacity-95");
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr)(div1, "class", "relative w-full h-0 max-w-4xl mx-auto");
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr)(header, "class", "");
    },
    m: function m(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
  var _$$props$menuOpen = $$props.menuOpen,
      menuOpen = _$$props$menuOpen === void 0 ? false : _$$props$menuOpen;
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmaxxreno"] = self["webpackChunkmaxxreno"] || [];
